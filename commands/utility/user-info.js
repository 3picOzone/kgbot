...
module.exports = {
	name: 'user-info',                  	 											// Command name (same as the file.js name)
	description: 'Display info about yourself',											// info that gets pulled by the help command for a description
