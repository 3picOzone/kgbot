...
module.exports = {
	name: 'Server',		                  	 											// Command name (same as the file.js name)
	description: 'Display info about this server',										// info that gets pulled by the help command for a description
